...
export class WcColorElement extends EvoElement() {
  ...
  constructor() {
    ...
    // Event handlers
    ael(this.#els.sel, 'pointerdown', (evt)=>this.#pointerDownHandler(evt, {...evt.target.dataset}));
    ael(this.#els.sel, 'pointermove', (evt)=>this.#pointerMoveHandler(evt, {...evt.target.dataset}));
    ael(this.#els.sel, 'pointerup', (evt)=>this.#pointerUpHandler(evt, {...evt.target.dataset}));
