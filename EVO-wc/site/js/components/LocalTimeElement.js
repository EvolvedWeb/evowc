...
export class LocalTimeElement extends EvoElement() {
  ...
  constructor() {
    ...
    // Event handlers
    ael(this.#els.el1, 'click', (evt)=>this.#setLocale(evt, {...evt.target.dataset}));
    ael(this.#els.el2, 'click', (evt)=>this.#setLocale(evt, {...evt.target.dataset}));
    ael(this.#els.el3, 'click', (evt)=>this.#setLocale(evt, {...evt.target.dataset}));
    ael(this.#els.el4, 'click', (evt)=>this.#setLocale(evt, {...evt.target.dataset}));
