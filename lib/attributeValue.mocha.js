...
const { decodeAttributeValue, encodeAttributeValue } = require('./attributeValue.js')
...
describe('encodeAttributeValue tests', function () {
  ...
  it('should not encode nonn strings', () => {
    expect(encodeAttributeValue()).to.equal(undefined);
