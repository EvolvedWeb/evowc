...
function handleKeyEvents(folder) {
...
function spawnBuild(changes = [], isDevBuild = false) {
  return new Promise(
    (resolve, reject) => {
      ...
      console.log(`Running: \x1b[32mnpm ${args.join(' ')}\x1b[0m`, del.join(' '));
      // @ts-ignore
