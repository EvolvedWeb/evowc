 ...
 * @returns 
 */
function parseBinding(val, element, attribute, type, availableVars, inForLoop, forElementName) {
  ...
  if (property === 'value') {
    ...
    if (srcObj === 'this') {
      ...
      loopItemHandlerName = `#loopHandler_${loopHandlerIndex++}`;
      inputSetter = `${srcVar} = evt.target.value;`;
