...
export function getCP1Code(event) {
  ...
  evtOptions.unique = evtOptions.passive || evtOptions.once || evtOptions.capture || false;
  evtOptions.uniqueFor2WayBinding = evtOptions.passive || evtOptions.once || !evtOptions.capture || false;
