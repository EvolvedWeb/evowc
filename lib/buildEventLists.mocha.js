...
describe('buildEventLists tests', function () {
  ...
  it('should process just bindings', () => {
    ...
    const expected = {
      eventList: [
        ...
        "ael( el1, 'input', (evt)=>this.#title_onInputHandler_1(evt, {...evt.target.dataset}))",
        "ael( el2, 'input', (evt)=>this.#title_onInputHandler_2(evt, {...evt.target.dataset}))"
      ],
      inputHandlerList: [
  ...
  it('should process Invalid PSI on an event', () => {
    const list = [
      {
        bindings: [],
        children: [],
