 ...
 */
export function xmlToComponentObj(source, options) {
  ...
  if (!Array.isArray(sourceObj) || sourceObj.length === 0) {
  ...
  const component = new Component(sourceObj[0][':@'], sourceObj[0].component, options);
