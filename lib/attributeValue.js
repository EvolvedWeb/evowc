const { ATTRIBUTE_ENCODE_RE, ATTRIBUTE_ENCODING_LIST, ATTRIBUTE_DECODING_LIST } = require("./enums");
 ...
 * @returns string - the decoded attribure value
 */
 ...
 * @returns string - The encoded attribure value
 */
